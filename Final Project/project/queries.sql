...
JOIN "screenshots" ON "game"."game_id" = "screenshots"."game_id"                            -- To show the screenshors of the game
JOIN "promotional_video" ON "game"."game_id" = "promotional_video"."promotional_video_id"   -- To show the videos related to the game
JOIN "game_link" ON "game"."game_id" = "game_link"."game_id"                                -- To shows store page / official sites of the game
JOIN "game_game_relations" ON "game"."game_id" = "game_game_relations"."game_1"             -- To show all the games related to the game
JOIN "people_in" ON "game"."game_id" = "people_in"."game_id"                                -- To show all the people who worked in the game
JOIN "user_revie" ON "game"."game_id" = "user_game_status"."game_id"                        -- Get all the user reviews of a game
...
SELECT "games"."title" AS "Game Title", AVG(*) AS "Rating" 
FROM "user_review"
JOIN "games" ON "user_review"."game_id" = "games"."game_id"
GROUP BY "user_review"."game_id"
...
NATURAL JOIN "club_post"        -- Maybe to show all the title of the post (depends on the page layout)
JOIN "club_post_media" ON "club_post"."club_post_id" = "club_post_media"."club_post_media_id"   -- If any media needs to be shown
JOIN "club_post_comment" ON "club_post"."club_post_id" = "club_post_comment"."club_post_comment"."club_post_comment_id" -- If any comments needs to be shown
